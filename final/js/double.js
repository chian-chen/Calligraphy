...
//     $("img-Picture").on("mousedown", "img-Picture", function (a) {
//         "move" == $(this).css("cursor") ? (e = !0, movingTextarea = a.target, $(movingTextarea).css({
//             "background-color": "rgba(192, 192, 0, 0.2)"
//         }), starting = {
//             X: a.pageX,
//             Y: a.pageY
//         }) : e = !1
//     }).on("mousemove", "img-Picture", function (a) {
//         0 == e ? a.offsetX < 5 || a.offsetX > $(this).innerWidth() - 5 || a.offsetY < 5 || a.offsetY > $(this).innerHeight() - 5 ? $(".text-editor").css({
//             cursor: "move"
//         }) : $("img-Picture").css({
//             cursor: "text"
//         }) : (delta = {
//             X: a.pageX - starting.X,
//             Y: a.pageY - starting.Y
//         }, final = {
//             X: $(movingTextarea).position().left + delta.X,
//             Y: $(movingTextarea).position().top + delta.Y
//         }, $(movingTextarea).css({
//             left: final.X
//         }), $(movingTextarea).css({
//             top: final.Y
...
//             Y: a.pageY
//         })
//     }).on("mouseup", "img-Picture", function (a) {
//         e = !1, $(movingTextarea).css({
